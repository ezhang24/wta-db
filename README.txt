...
Here is a suggested guide to using the app as a user:
    ...
    3. Select option [s] to show the number of matches played by surface
...
In future iterations, we would like to add more options for both the
user and admin. We would also like to separate the user interface into one
